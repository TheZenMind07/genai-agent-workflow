...
- `assets/genai.svg`, `LICENSE`, [MARKETPLACE.md](./MARKETPLACE.md); `subagentStop` hooks and `workflow-hooks.mdc`
...
- Extracted from [genai_node_rules](https://github.com/genai/genai_node_rules) to keep Node standards focused on development conventions only

[Unreleased]: https://github.com/genai/genai_agent_rules/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/genai/genai_agent_rules/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/genai/genai_agent_rules/releases/tag/v1.0.0
