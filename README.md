...
**Current release:** [v1.1.0](https://github.com/genai/genai_agent_rules/releases/tag/v1.1.0)
...
| JavaScript baseline | **genai-js-rules** plugin here *(planned)* or [genai_js_rules](https://github.com/genai/genai_js_rules) |
| TypeScript conventions | **genai-ts-rules** plugin here *(planned)* or [genai_ts_rules](https://github.com/genai/genai_ts_rules) |
| Node.js coding, architecture, lint, security | [genai_node_rules](https://github.com/genai/genai_node_rules) *(optional)* |
...
2. Install **GenAI Agent Workflow** (`genai-agent-workflow`) from the **genai-plugins** marketplace (this repo).
