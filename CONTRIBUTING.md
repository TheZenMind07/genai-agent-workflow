...
- **Out of scope** — Language/runtime coding standards, lint rules, framework-specific architecture, or project-specific app configuration. Those belong in optional sibling standards repos (e.g. [genai_node_rules](https://github.com/genai/genai_node_rules), [genai_ts_rules](https://github.com/genai/genai_ts_rules), [genai_js_rules](https://github.com/genai/genai_js_rules)) or the consuming repo.
